<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_qapAttachments.aspx.vb" Inherits="EF_qapAttachments" title="Edit: Attachments" %>
...
<ContentTemplate>
  <asp:Label ID="LabelqapAttachments" runat="server" Text="&nbsp;Edit: Attachments" Width="100%" CssClass="sis_formheading"></asp:Label>
  <LGM:ToolBar0 
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "qapAttachmentsGetByID"
  UpdateMethod="UZ_qapAttachmentsUpdate"
  DeleteMethod="UZ_qapAttachmentsDelete"
