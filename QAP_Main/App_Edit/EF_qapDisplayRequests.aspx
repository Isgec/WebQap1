<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_qapDisplayRequests.aspx.vb" Inherits="EF_qapDisplayRequests" title="Display: Requests" %>
<asp:Content ID="CPHqapRequests" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="page">
<asp:UpdatePanel ID="UPNLqapRequests" runat="server" >
<ContentTemplate>
  <asp:Label ID="LabelqapRequests" runat="server" Text="&nbsp;Display: Requests" Width="100%" CssClass="sis_formheading"></asp:Label>
  <LGM:ToolBar0 
    ID = "TBLqapRequests"
    ToolType = "lgNMEdit"
    UpdateAndStay = "False"
