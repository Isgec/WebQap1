<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_qapApproverAttachments.aspx.vb" Inherits="GF_qapApproverAttachments" title="Maintain List: Attachments By Approver" %>
...
<asp:UpdatePanel ID="UPNLqapApproverAttachments" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ...
      AddUrl = "~/QAP_Main/App_Create/AF_qapApproverAttachments.aspx"
