<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_qapRequests.aspx.vb" Inherits="GF_qapRequests" title="Maintain List: Requests" %>
...
<asp:UpdatePanel ID="UPNLqapRequests" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ID = "TBLqapRequests"
      ToolType = "lgNMGrid"
      EditUrl = "~/QAP_Main/App_Edit/EF_qapRequests.aspx"
      AddUrl = "~/QAP_Main/App_Create/AF_qapRequests.aspx?skip=1"
