Partial Class GF_qapApproverAttachments
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/QAP_Main/App_Display/DF_qapApproverAttachments.aspx"
  ...
  Protected Sub GVqapApproverAttachments_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVqapApproverAttachments.Init
    DataClassName = "GqapApproverAttachments"
    SetGridView = GVqapApproverAttachments
  End Sub
