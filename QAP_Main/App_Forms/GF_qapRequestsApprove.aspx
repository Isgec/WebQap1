<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_qapRequestsApprove.aspx.vb" Inherits="GF_qapRequestsApprove" title="Maintain List: Requests Approve" %>
...
<asp:UpdatePanel ID="UPNLqapRequestsApprove" runat="server">
  <ContentTemplate>
    <asp:Label ID="LabelqapRequestsApprove" runat="server" Text="&nbsp;List: Requests Approve" Width="100%" CssClass="sis_formheading"></asp:Label>
    <table width="100%"><tr><td class="sis_formview"> 
    <LGM:ToolBar0 
      ID = "TBLqapRequestsApprove"
      ToolType = "lgNMGrid"
      EditUrl = "~/QAP_Main/App_Edit/EF_qapRequestsApprove.aspx"
      EnableAdd = "False"
      ValidationGroup = "qapRequestsApprove"
      Skin = "tbl_blue"
      runat = "server" />
    <asp:UpdateProgress ID="UPGSqapRequestsApprove" runat="server" AssociatedUpdatePanelID="UPNLqapRequestsApprove" DisplayAfter="100">
      <ProgressTemplate>
   ...
   var script_ApproverRemarks = {
    ...
    <asp:GridView ID="GVqapRequestsApprove" SkinID="gv_silver" BorderColor="#A9A9A9" width="100%" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ODSqapRequestsApprove" DataKeyNames="RequestNo">
      <Columns>
        <asp:TemplateField>
          <ItemTemplate>
						<Table><tr>
          ...
          <ItemTemplate>
            ...
            ToolTip="Enter value for Approver Remarks."
					...
					<asp:RequiredFieldValidator 
						...
						Text = "Approver Remarks is required."
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_qapRequestsApproveSelectList"
      TypeName = "SIS.QAP.qapRequestsApprove"
      SelectCountMethod = "qapRequestsApproveSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVqapRequestsApprove" EventName="PageIndexChanged" />
