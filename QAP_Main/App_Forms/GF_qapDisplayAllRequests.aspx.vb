Partial Class GF_qapDisplayAllRequests
	Inherits SIS.SYS.GridBase
	Protected Sub GVqapRequests_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVqapRequests.RowCommand
		If e.CommandName.ToLower = "lgedit".ToLower Then
			Try
				Dim RequestNo As Int32 = GVqapRequests.DataKeys(e.CommandArgument).Values("RequestNo")
				Dim RedirectUrl As String = TBLqapRequests.EditUrl & "?RequestNo=" & RequestNo
		...
		If e.CommandName.ToLower = "initiatewf".ToLower Then
			Try
				Dim RequestNo As Int32 = GVqapRequests.DataKeys(e.CommandArgument).Values("RequestNo")
				SIS.QAP.qapRequests.InitiateWF(RequestNo)
				GVqapRequests.DataBind()
			Catch ex As Exception
			End Try
		End If
	End Sub
	Protected Sub GVqapRequests_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVqapRequests.Init
		DataClassName = "GqapRequests"
		SetGridView = GVqapRequests
	End Sub
