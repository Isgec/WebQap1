<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_qapDisplayAllRequests.aspx.vb" Inherits="GF_qapDisplayAllRequests" title="Display List: Requests" %>
<asp:Content ID="CPHqapRequests" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="page">
<asp:UpdatePanel ID="UPNLqapRequests" runat="server">
  <ContentTemplate>
    <asp:Label ID="LabelqapRequests" runat="server" Text="&nbsp;List: All Requests" Width="100%" CssClass="sis_formheading"></asp:Label>
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_qapRequestsSelectListAll"
