Partial Class GF_qapAttachments
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/QAP_Main/App_Display/DF_qapAttachments.aspx"
  ...
  Protected Sub GVqapAttachments_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVqapAttachments.Init
    DataClassName = "GqapAttachments"
    SetGridView = GVqapAttachments
  End Sub
